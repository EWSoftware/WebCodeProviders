...
//
// This file contains a custom C# code provider that is able to output an individual XML comments file for each
// unit that is compiled to a folder of your choice.  This changes the default behavior which overwrites the
// comments file on each invocation and dumps it into the temporary ASP.NET compilation folder.
//
...
{
    /// <summary>
    /// This is a custom C# code provider that is able to output an individual XML comments file for each unit
    /// that is compiled to a folder of your choice.
    /// </summary>
    /// <remarks>This changes the default behavior which overwrites the comments file on each invocation and
    /// dumps it into the temporary ASP.NET compilation folder.
    /// 
    ...
    public class CSharpCodeProviderWithDocs : CSharpCodeProvider
    {
        ...
        public CSharpCodeProviderWithDocs(IDictionary<string, string> providerOptions) : base(providerOptions)
        {
        }
        #endregion
